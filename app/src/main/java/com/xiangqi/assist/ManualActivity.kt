...
import com.xiangqi.assist.adapters.HistoryAndTrendAdapter
import com.xiangqi.assist.utils.CopyAssetsUtil
import com.xiangqi.assist.utils.PathUtil
import com.xiangqi.assist.controllers.ControllerListener
import com.xiangqi.assist.controllers.ManualController
import com.xiangqi.assist.databinding.ActivityManualBinding
import com.xiangqi.assist.gamelogic.GameStatus
import com.xiangqi.assist.manuals.XQFParser
import com.xiangqi.assist.views.ChessView
...
class ManualActivity() : AppCompatActivity(), ControllerListener,
    ...
    private val PREFS_NAME = "com.xiangqi.assist.manual.preferences"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        UiChrome.apply(this, binding.root)
...
//                processPath(PathUtil.getInternalAppFilesDir(this,"XQF"))
    ...
    override fun onGameEvent(status: GameStatus?, message: String?) {
        ...
        when(status) {
            ...
            null -> message?.let { setStatusText(it) }
            GameStatus.MULTIPV -> {
                // show message
                message?.let { setStatusText(it) }
